...
const TIPO_COLOR = {
  ...
  'Dataset':        'bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-500',
}
      ...
      <div className="w-full max-w-xl bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden">
        <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100 dark:border-slate-700">
          ...
          <input
            ...
            className="flex-1 text-sm text-slate-800 dark:text-slate-100 placeholder:text-slate-500 outline-none bg-transparent"
          />
  ...
  return (
    <>
      ...
      <div className="min-w-0">
        ...
        {item.subtitulo && (
          <p className="text-xs text-slate-500 truncate mt-0.5">{item.subtitulo}</p>
        )}
      </div>
    </>
  )
