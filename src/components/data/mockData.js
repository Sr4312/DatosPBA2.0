...
export const hilos = [
  {
    ...
    imagen: '/images/hilos/exportaciones-pba-2025.jpg',
  },
  {
    id: 'h-iibb-recursos-propios-pba',
    titulo: 'Ingresos Brutos concentra casi el 80% de los recursos propios de la PBA',
    resumen: 'En 1999, Ingresos Brutos representaba el 51% de los recursos propios de la PBA. Hoy casi el 80%. Un impuesto que no para de crecer y uno de los más distorsivos que existen.',
    fecha: '17 abr. 2026',
    fechaOrden: '2026-04-17',
    tema: 'Fiscal',
    plataforma: 'Twitter/X',
    tags: ['IIBB', 'recaudación', 'PBA', 'fiscal'],
    url: 'https://x.com/DatosPBA/status/2045277275793363115?s=20',
    imagen: '/images/hilos/iibb-recursos-propios-pba.jpg',
  },
  {
    id: 'h-agua-potable-gba-2026',
    titulo: 'En 11 de 24 municipios del GBA, menos del 75% de los hogares tiene agua de red',
    resumen: 'En el GBA, el acceso al agua potable sigue siendo una deuda estructural. En Malvinas Argentinas y José C. Paz, ni siquiera llega al 15%. Una desigualdad básica que persiste.',
    fecha: '17 abr. 2026',
    fechaOrden: '2026-04-17',
    tema: 'Infraestructura',
    plataforma: 'Twitter/X',
    tags: ['agua', 'GBA', 'INDEC', 'infraestructura'],
    url: 'https://x.com/DatosPBA/status/2045212628977398050?s=20',
    imagen: '/images/hilos/agua-potable-gba-2026.jpg',
  },
  {
    id: 'h-crecimiento-vs-cloacas-pba',
    titulo: 'Los municipios que más crecieron son los que peor infraestructura tienen',
    resumen: 'San Vicente: +65% de población, 43,7% de cloacas. General Rodríguez: +64% de población, 24,2% de cloacas. El bonaerense se mueve donde el Estado no llegó. Fuente: INDEC, CNPHV 2022.',
    fecha: '16 abr. 2026',
    fechaOrden: '2026-04-16',
    tema: 'Infraestructura',
    plataforma: 'Twitter/X',
    tags: ['demografía', 'cloacas', 'PBA', 'INDEC'],
    url: 'https://x.com/DatosPBA/status/2044860039458910576?s=20',
    imagen: '/images/hilos/crecimiento-vs-cloacas-pba.jpg',
  },
  {
    id: 'h-brecha-cloacal-gba',
    titulo: 'La brecha cloacal del GBA es de 90 puntos porcentuales',
    resumen: 'Vicente López 98,4%, San Isidro 94,6% y Tres de Febrero 93,9% frente a José C. Paz 8,1%, Malvinas Argentinas 9,3% y Moreno 32,2%. Fuente: INDEC, CNPHV 2022.',
    fecha: '16 abr. 2026',
    fechaOrden: '2026-04-16',
    tema: 'Infraestructura',
    plataforma: 'Twitter/X',
    tags: ['cloacas', 'GBA', 'desigualdad', 'INDEC'],
    url: 'https://x.com/DatosPBA/status/2044863105327349944?s=20',
    imagen: '/images/hilos/brecha-cloacal-gba.jpg',
  },
  {
    id: 'h-tasa-vial-combustible-pba',
    titulo: 'La nafta también paga tributo municipal: Gral. Pueyrredón cobra 3% por litro',
    resumen: 'Gral. Pueyrredón cobra la tasa vial más alta de la Provincia: 3% por litro de combustible. En el Conurbano el rango va de 0,9% a 2,5%, con la mayoría del sur del GBA convergiendo en 2%.',
    fecha: '14 abr. 2026',
    fechaOrden: '2026-04-14',
    tema: 'Fiscal',
    plataforma: 'Twitter/X',
    tags: ['tasa vial', 'combustible', 'municipios', 'PBA'],
    url: 'https://x.com/DatosPBA/status/2044100216740057115?s=20',
    imagen: '/images/hilos/tasa-vial-combustible-pba.jpg',
  },
  {
    id: 'h-iibb-precios-kpmg-2025',
    titulo: 'IIBB es el impuesto que más encarece los precios en Argentina',
    resumen: 'Según la encuesta KPMG Argentina 2025, Ingresos Brutos concentra el 61% de las menciones como el impuesto que más encarece los precios. Buenos Aires es la provincia más gravosa del país.',
    fecha: '13 abr. 2026',
    fechaOrden: '2026-04-13',
    tema: 'Fiscal',
    plataforma: 'Twitter/X',
    tags: ['IIBB', 'KPMG', 'precios', 'impuestos'],
    url: 'https://x.com/DatosPBA/status/2043758822771069294?s=20',
    imagen: '/images/hilos/iibb-precios-kpmg-2025.jpg',
  },
]
