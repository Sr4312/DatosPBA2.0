...
export default function Hilos() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      <div className="mb-10">
        <h1 className="font-display text-4xl font-bold text-[#0F172A] dark:text-slate-100 tracking-tight mb-3">Hilos y publicaciones destacadas</h1>
        <p className="text-lg text-slate-600 dark:text-slate-500">Análisis en formato hilo para redes sociales</p>
      </div>
      ...
      {filtered.length > 0 ? (
        ...
        <div className="text-center py-20">
          <p className="text-slate-500 text-sm">No se encontraron publicaciones con los filtros seleccionados.</p>
        </div>
      )}
    </div>
  )
