  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      <m.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-10">
        <h1 className="font-display text-4xl font-bold text-[#0a1628] dark:text-slate-100 tracking-tight mb-3">Hilos y publicaciones destacadas</h1>
        <p className="text-lg text-slate-600 dark:text-slate-400">Análisis en formato hilo para redes sociales</p>
      </m.div>
