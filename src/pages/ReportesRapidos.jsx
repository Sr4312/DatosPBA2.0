    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <m.div
          ...
          className="mb-10"
        >
          <h1 className="font-display text-4xl font-bold text-[#0F172A] dark:text-slate-100 tracking-tight mb-3">Reportes rápidos</h1>
          <p className="text-lg text-slate-600 dark:text-slate-500">Datos puntuales, comparativas y hallazgos concisos</p>
        </m.div>
