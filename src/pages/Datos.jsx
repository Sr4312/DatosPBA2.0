  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      <m.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-10">
        <h1 className="font-display text-4xl font-bold text-[#0F172A] dark:text-slate-100 tracking-tight mb-3">Base de datos y descargas</h1>
        <p className="text-lg text-slate-600 dark:text-slate-500">Datasets abiertos para análisis independiente</p>
      </m.div>
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-[#0F172A] dark:text-slate-100 mb-3">Datasets en preparación</h2>
        <p className="text-slate-500 dark:text-slate-500 text-sm max-w-sm leading-relaxed">
